...
(() => {
  ...
  function renderItem(it) {
    ...
    if (it.primary) {
      // Plus pro Add v Bristolu místo SVG ikony
      const inner = it.ico === 'i-plus' ? '+' : svgIcon(it.ico);
