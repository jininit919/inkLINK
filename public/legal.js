...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      #cookieBanner .cb-text{flex:1;min-width:220px;font-family:'Helvetica Neue','Helvetica','Arial',sans-serif;font-size:11px;color:#aaa;line-height:1.6}
      ...
      #cookieBanner .cb-actions button{font-family:'Helvetica Neue','Helvetica','Arial',sans-serif;font-size:13px;letter-spacing:0.1em;padding:10px 20px;border:1px solid #444;cursor:pointer;transition:all 0.15s;min-width:140px;text-align:center}
      ...
      .lf-inner{max-width:900px;margin:0 auto;font-family:'Helvetica Neue','Helvetica','Arial',sans-serif;font-size:10px;color:#555;line-height:1.8;text-align:center;display:flex;flex-direction:column;align-items:center;gap:14px}
      .lf-brand{font-family:'Helvetica Neue','Helvetica','Arial',sans-serif;font-size:28px;letter-spacing:0.25em;color:#222}
